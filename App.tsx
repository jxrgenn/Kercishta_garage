              ...
              <div className="max-w-7xl mx-auto px-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16">
                  <div className="text-center">
                    ...
                    <p className="text-3xl lg:text-4xl font-black text-white uppercase leading-tight">MO-SA</p>
                    <p className="text-3xl lg:text-4xl font-black text-white uppercase leading-tight">07:00-16:00</p>
                  </div>
                  {[
